...
- `[2ddcff4]` (2026-09-09) docs: update agent briefing with multi-computer handoff protocol
- `[c4cbbcd]` (2026-09-09) docs: update agent briefing with multi-computer handoff protocol
