...
- **Repository Name**: `ats-auto-apply`
- **Visibility**: `Public`
- **Default Branch**: `main`
- **Last Updated / Pushed**: 2026-06-11
...
- **Notable Top-Level Files**: `.gitignore`, `LICENSE`, `README.md`, `api.js`, `db.js`, `db_migrate_phase9.js`, `docker-compose.yml`, `ingestion_worker.js`, `jobspy_runner.py`, `jobspy_schema_scraper.js`, `llm_engine.js`, `package-lock.json`
